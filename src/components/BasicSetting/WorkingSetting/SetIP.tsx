...
export default function WorkingSettingIP() {
  ...
  return (
    <form className="p-6 flex gap-x-20 justify-between items-start">
      <Txt variant="subtitle1">아이피설정</Txt>
      ...
      <div className="flex flex-1 gap-x-2">
        ...
        <div className="flex flex-col items-center">
          ...
          <Button variant="outline" radius="none" color="blue" className="px-3 py-5 cursor-pointer">
            <PiPlusBold size={20} />
          </Button>
        </div>
      </div>
      <Button variant="outline" color="gray" className="px-8 cursor-pointer">
